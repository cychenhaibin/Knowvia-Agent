...
func (c *Client) CompleteWithConfig(
	ctx context.Context,
	systemPrompt string,
	userPrompt string,
...
func (c *Client) Stream(
	...
	return c.StreamWithConfig(ctx, systemPrompt, userPrompt, domain.ChatRuntimeConfig{}, onDelta, nil)
}

func (c *Client) StreamWithConfig(
	ctx context.Context,
	systemPrompt string,
	userPrompt string,
	runtime domain.ChatRuntimeConfig,
...
func (c *Client) resolveRuntime(runtime domain.ChatRuntimeConfig) (baseURL string, apiKey string, modelName string) {
